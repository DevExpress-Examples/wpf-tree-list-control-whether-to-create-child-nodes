...
Namespace HasChildNodes
	...
	Public Class ViewModel
		...
		Private Sub InitBetaronProjectData(ByVal betaronProject As ProjectObject)
			...
			Dim Task11 As New Task() With {
				.Name = "Information Gathering",
				.Executor = "Kaiden Savastano",
				.Tasks = New ObservableCollection(Of Task)(),
				.HasChildNodes = False
			}
			Task11.Tasks.Add(New Task() With {
			...
			Dim Task12 As New Task() With {
				.Name = "Planning",
				.Executor = "Manley Difrancesco",
				.Tasks = New ObservableCollection(Of Task)(),
				.HasChildNodes = True
			}
			Task12.Tasks.Add(New Task() With {
				.Name = "Documentation",
			...
			Dim Task13 As New Task() With {
				.Name = "Design",
				.Executor = "Clint Mary",
				.Tasks = New ObservableCollection(Of Task)(),
				.HasChildNodes = True
			}
			Task13.Tasks.Add(New Task() With {
		...
		Private Sub InitStantoneProjectData(ByVal stantoneProject As ProjectObject)
			...
			Dim Task21 As New Task() With {
				.Name = "Information Gathering",
				.Executor = "Huyen Trinklein",
				.Tasks = New ObservableCollection(Of Task)(),
				.HasChildNodes = False
			}
			Task21.Tasks.Add(New Task() With {
				.Name = "Market research",
			...
			Dim Task22 As New Task() With {
				.Name = "Planning",
				.Executor = "Alfredo Sookoo",
				.Tasks = New ObservableCollection(Of Task)(),
				.HasChildNodes = True
			}
			Task22.Tasks.Add(New Task() With {
				.Name = "Documentation",
				.Executor = "Gorf Wobbe",
				.State = "Completed",
				.HasChildNodes = True
			...
			Dim Task23 As New Task() With {
				.Name = "Design",
				.Executor = "Saphire Plump",
				.Tasks = New ObservableCollection(Of Task)(),
				.HasChildNodes = True
			}
			Task23.Tasks.Add(New Task() With {
				.Name = "Design of a web pages",
			...
			Dim Task24 As New Task() With {
				.Name = "Development",
				.Executor = "Lauren Partain",
				.Tasks = New ObservableCollection(Of Task)(),
				.HasChildNodes = True
			}
			Task24.Tasks.Add(New Task() With {
				.Name = "Design",
